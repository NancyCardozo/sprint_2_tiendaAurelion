...
<div class="download-section">
    <h3 style='color: #1f77b4; margin-top: 0; margin-bottom: 0.3rem;'>📥 DESCARGAR INFORMES</h3>
    <p style='color: #2c3e50; margin-bottom: 0; font-size: 0.95rem;'>
        Exporta los datos y análisis en diferentes formatos
    </p>
</div>
""", unsafe_allow_html=True)
...
with col_d1:
    st.download_button(
        label="📄 Resumen TXT",
        data=generar_resumen_texto(datos_filtrados),
...
with tab4:
    ...
    subtab1, subtab2, subtab3, subtab4 = st.tabs(["🎯 Categoría", "🌍 Ciudad", "⭐ Productos", "📅 Temporal"])
